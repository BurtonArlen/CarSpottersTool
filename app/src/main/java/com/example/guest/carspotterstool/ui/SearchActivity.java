...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getContributionsByYear(queryYear);
        getContributionsByModel(queryModel);
        getContributionsByMake(queryMake);
    }

    private void getContributionsByYear(String queryYear){
    ...
    private void getContributionsByModel(String queryModel){
        final ArrayList<PhotoContribution> userContributions = new ArrayList<>();
        DatabaseReference userRef = FirebaseDatabase.getInstance()
                .getReference(Constants.FIREBASE_CHILD_CONTRIBUTIONS)
                .child(Constants.FIREBASE_CHILD_YEAR)
    ...
    private void getContributionsByMake(String queryMake){
        final ArrayList<PhotoContribution> userContributions = new ArrayList<>();
        DatabaseReference userRef = FirebaseDatabase.getInstance()
                .getReference(Constants.FIREBASE_CHILD_CONTRIBUTIONS)
                .child(Constants.FIREBASE_CHILD_YEAR)
